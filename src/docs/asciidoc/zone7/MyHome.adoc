...
Bücher mit dem Titel "xref:../neuland/index.adoc[Neuland,role=external,window=_blank]". Oh, denke ich - er besitzt mein Buch, nice!
...
Händler ist mit Sicherheit wer da. Der Händler nimmt der Drohne den Schrank ab und bringt ihn ins Lager. Das wars.
